...
## 2026-06-22 - Missing Loading State on Admin Forms
...
## 2026-06-22 - Decorative Emoji Accessibility
...
## 2026-06-22 - Confirmation Dialog for Non-Destructive Actions
...
## 2026-06-22 - Providing Context for Optional Fields with .form-hint
...
## 2026-06-22 - Focus styles for visually hidden native inputs
**Learning:** When hiding native form controls (like radio buttons using opacity: 0) to build custom interactive components, keyboard navigation focus states are lost. Explicit `:focus-visible` styles must be applied to the surrounding visible wrapper element using a sibling selector.
**Action:** Always replicate the global focus style on the visible wrapper element when visually hiding native inputs for custom UI components.
