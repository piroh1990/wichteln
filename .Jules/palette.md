...
## 2026-06-14 - Missing Loading State on Admin Forms
...
## 2026-06-14 - Decorative Emoji Accessibility
...
## 2026-06-14 - Confirmation Dialog for Non-Destructive Actions
...
## 2026-06-14 - Providing Context for Optional Fields with .form-hint
...
## 2026-06-14 - Focus-visible on Hidden Native Controls
**Learning:** When hiding native form controls (like radio buttons or checkboxes using `opacity: 0`) to build custom interactive components (like cards acting as radio buttons), the browser's default focus outline is no longer visible, breaking keyboard navigation accessibility.
**Action:** Always ensure keyboard navigation remains visible by applying explicit `:focus-visible` styles to the surrounding visible wrapper element using a sibling selector (e.g., `input[type="radio"]:focus-visible ~ .card-content`).
