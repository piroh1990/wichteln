...
## 2026-06-23 - Missing Loading State on Admin Forms
...
## 2026-06-23 - Decorative Emoji Accessibility
...
## 2026-06-23 - Confirmation Dialog for Non-Destructive Actions
...
## 2026-06-23 - Providing Context for Optional Fields with .form-hint
...
## 2026-06-23 - Focus States for Hidden Native Controls
**Learning:** When building custom interactive components (like cards acting as radio buttons) where the native `<input>` is visually hidden (e.g., `opacity: 0`), the browser's default focus ring is also hidden. This completely breaks keyboard navigation visibility for screen readers and power users, as they cannot see which item is focused when tabbing.
**Action:** Always apply explicit `:focus-visible` styles to the surrounding visible wrapper element using a sibling selector (e.g., `input[type="radio"]:focus-visible ~ .card-content`) to restore keyboard navigation visibility.
